    ...
    class Program
    {
        ...
        {            
            try
            {
                ...
                PROC = new FakePinProc(MachineType.PDB, new ConsoleLogger());
                ...
                PROC.SetupProcMachine(config, _coils: _coils, _switches: _switches, _lamps:null, _leds: _leds, _gi:null, _steppers:null);
